...
import com.sendsay.sdk.repository.SegmentsCache
...
internal class SegmentsManagerImplTest {
    ...
    fun before() {
        ...
        projectFactory = SendsayProjectFactory(ApplicationProvider.getApplicationContext(), configuration)
        segmentsCache = spyk(SegmentsCacheImpl(ApplicationProvider.getApplicationContext(), SendsayGson.instance))
    ...
    fun `should stop fetch for unregistered callback`() {
        ...
        Sendsay.registerSegmentationDataCallback(segmentCallback)
        Sendsay.unregisterSegmentationDataCallback(segmentCallback)
    ...
    fun `should not notify callback for same data if includeFirstLoad is false`() {
        ...
        Sendsay.registerSegmentationDataCallback(callback)
    ...
    fun `should notify same data only callback with includeFirstLoad is true - callback registration`() {
        ...
        Sendsay.registerSegmentationDataCallback(validCallback)
        ...
        Sendsay.registerSegmentationDataCallback(invalidCallback)
