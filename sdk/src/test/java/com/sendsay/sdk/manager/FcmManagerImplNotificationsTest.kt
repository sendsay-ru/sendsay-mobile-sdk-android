...
import com.sendsay.sdk.models.NotificationAction.Companion.ACTION_TYPE_BUTTON
import com.sendsay.sdk.models.NotificationAction.Companion.ACTION_TYPE_NOTIFICATION
...
internal class FcmManagerImplNotificationsTest(
    ...
    companion object {
        ...
        private fun validateIntent(
            ...
            assertEquals(expectedNotificationAction, intent.extras?.get(SendsayExtras.EXTRA_ACTION_INFO))
            assertEquals(expectedNotificationData, intent.extras?.get(SendsayExtras.EXTRA_DATA))
            assertEquals(expectedPayload, intent.extras?.get(SendsayExtras.EXTRA_CUSTOM_DATA))
        }
        ...
        private val testCases = arrayListOf(
            ...
            TestCase(
                ...
                expectedNotificationMatcher = {
                    ...
                    validateIntent(
                        shadowOf(it.contentIntent).savedIntent,
                        SendsayExtras.ACTION_DEEPLINK_CLICKED,
            ...
            TestCase(
                ...
                expectedNotificationMatcher = {
                    ...
                    validateIntent(
                        shadowOf(it.contentIntent).savedIntent,
                        SendsayExtras.ACTION_URL_CLICKED,
            ...
            TestCase(
                ...
                notificationPayload = NotificationTestPayloads.NOTIFICATION_WITH_DENIED_CONSENT,
                expectNotificationCreated = true,
                expectedNotificationId = 1,
                expectedNotificationMatcher = {},
                expectedTrackingData = NotificationData(
                    dataMap = hashMapOf(
                        "event_type" to "campaign",
                ...
                expectedNotificationData = mapOf(
                    "campaign_name" to "Wassil's push",
                    "event_type" to "campaign",
                    "action_id" to 2.0,
                    "action_type" to "mobile notification",
