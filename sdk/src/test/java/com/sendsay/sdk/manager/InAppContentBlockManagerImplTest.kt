                ...
                <div class="in-app-message modal-in-app-message " style="background-color: #ffffff">
                    ...
                    <div class="content">
                        ...
                        <div class="buttons">
                            ...
                            <span class="button" style="color:#ffffff;background-color:#f44cac" data-link="https://sendsay.com?xnpe_force_track=true">
                                Web forced
                            </span>
...
//        every { fontCache.has(any()) } returns false
    ...
    fun `should auto-load messages content by configuration`() = runInSingleThread { idleThreads ->
        ...
        // flag is read from SendsayProject, need to be re-created
        val configuration = SendsayConfiguration(
            projectToken = "token",
            authorization = "Token auth",
            baseURL = "https://test.com",
