...
internal class SessionManagerTest : SendsaySDKTest() {
    private lateinit var eventManager: EventManager
    private lateinit var backgroundTimer: BackgroundTimerManager
    private lateinit var campaignRepository: CampaignRepository
    private lateinit var prefs: SendsayPreferencesImpl

    @Before
    fun prepareForTest() {
        mockkObject(Sendsay)
        every { Sendsay.sessionTimeout } returns 20.0
        ...
        prefs = SendsayPreferencesImpl(context)
    }
