    ...
    companion object {
        ...
        private val testCases = arrayListOf(
            ...
            TestCase(
                ...
                assertEquals(null, it.buttons)
                assertEquals(
                        NotificationPayload.ActionPayload(SendsayNotificationActionType.APP),
            ...
            TestCase(
                ...
                assertEquals(null, it.buttons)
                assertEquals(
                        NotificationPayload.ActionPayload(SendsayNotificationActionType.DEEPLINK, "app://test"),
                        it.notificationAction
                )
                assertEquals(NotificationData(), it.notificationData)
                assertEquals(null, it.attributes)
            ...
            TestCase(
                ...
                assertEquals(null, it.buttons)
                assertEquals(
                        NotificationPayload.ActionPayload(SendsayNotificationActionType.BROWSER, "http://google.com"),
                        it.notificationAction
                )
                assertEquals(NotificationData(), it.notificationData)
                assertEquals(null, it.attributes)
                ...
                assertEquals(
                        arrayListOf(
                                NotificationPayload.ActionPayload(
                                        SendsayNotificationActionType.APP,
                                        null,
                                        "Action 1 title"
                                ),
                                NotificationPayload.ActionPayload(
