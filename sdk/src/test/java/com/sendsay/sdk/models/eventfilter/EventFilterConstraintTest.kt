...
internal class EventFilterConstraintTest {
    ...
    internal class EventFilterConstraintCaseTest(
        ...
        fun `should serialize`() {
            assertEquals(serializedConstraint, SendsayGson.instance.toJson(constraint))
        }
        ...
        fun `should deserialize`() {
            assertEquals(
                constraint,
                SendsayGson.instance.fromJson(serializedConstraint, EventFilterConstraint::class.java)
            )
        }
    }
}
