...
import ru.sendsay.sdk.models.InAppMessageType.ALERT
import ru.sendsay.sdk.models.InAppMessageType.FREEFORM
import ru.sendsay.sdk.models.InAppMessageType.FULLSCREEN
import ru.sendsay.sdk.models.InAppMessageType.MODAL
import ru.sendsay.sdk.models.InAppMessageType.SLIDE_IN
import ru.sendsay.sdk.repository.FontCacheImpl
import ru.sendsay.sdk.repository.InAppMessageBitmapCacheImpl
import ru.sendsay.sdk.shadows.BadTokenShadowPopupWindow
...
internal class InAppMessagePresenterTest(
    ...
    fun `should dismiss the in-app after timeout has passed`() {
        ...
        mockkObject(Sendsay)
        every { Sendsay.presentedInAppMessage } returns presented
        every { Sendsay.inAppMessagePresenter } returns presenter
