...
internal class SendsayTrackPushDeliveredTest(
    ...
    fun `should track push delivered with public API`() {
        ...
        Sendsay.trackDeliveredPush(notificationData)
    ...
    private fun initSdk(notifImportance: NotificationChannelImportance) {
        ...
        (Sendsay.componentForTesting.fcmManager as FcmManagerImpl).ensureNotificationChannelExistence(
            context,
            manager
        )
    }
