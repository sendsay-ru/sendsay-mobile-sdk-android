...
import ru.sendsay.sdk.models.CustomerRecommendationResponse
...
internal class FetchManagerImpl(
    ...
    /**
     * Creates Callback to read HTTP response body and parses it into standardised {ru.sendsay.sdk.models.Result}
     */
     ...
     * Data are transformed to {ru.sendsay.sdk.models.Result} with success or error status info.
     */
