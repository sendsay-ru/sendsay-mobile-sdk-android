...
import ru.sendsay.sdk.models.AppInboxMessateType.UNKNOWN
...
internal class AppInboxManagerImpl(
    ...
    private fun requireMutualSendsayProject(onTokenCallback: (SendsayProject) -> Unit) {
        runOnBackgroundThread {
            onTokenCallback.invoke(projectFactory.mutualSendsayProject)
        }
    }
