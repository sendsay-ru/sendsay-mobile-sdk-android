...
import ru.sendsay.sdk.databinding.MessageInboxListItemBinding
import ru.sendsay.sdk.models.MessageItem
import ru.sendsay.sdk.util.Logger
import ru.sendsay.sdk.util.MessageItemViewHolder
...
internal class AppInboxAdapter(
    ...
    override fun onBindViewHolder(target: MessageItemViewHolder, position: Int) {
        ...
        Sendsay.initGate.waitForInitialize {
            runCatching {
                val sdkComponent = Sendsay.getComponent()
    ...
    private fun trackItemClicked(item: MessageItem) {
        ...
        Sendsay.trackAppInboxOpened(item)
    }
