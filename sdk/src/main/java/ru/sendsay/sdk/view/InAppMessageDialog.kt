...
import ru.sendsay.sdk.databinding.InAppMessageDialogBinding
import ru.sendsay.sdk.models.InAppMessageButtonType
import ru.sendsay.sdk.models.InAppMessagePayload
import ru.sendsay.sdk.models.InAppMessagePayloadButton
import ru.sendsay.sdk.style.ImagePosition
...
import ru.sendsay.sdk.util.UiUtils
import ru.sendsay.sdk.util.ensureOnMainThread
import ru.sendsay.sdk.util.setBackgroundColor
...
internal class InAppMessageDialog : InAppMessageView, Dialog {
    ...
    private fun setupFullscreen() {
        ...
        val padding = if (fullScreen) {
            context.resources.getDimensionPixelSize(R.dimen.sendsay_sdk_in_app_message_fullscreen_padding)
        } else {
            context.resources.getDimensionPixelSize(R.dimen.sendsay_sdk_in_app_message_dialog_padding)
        }
    ...
    private fun setupButton(buttonAction: Button, buttonPayload: InAppMessagePayloadButton?, buttonsCount: Int) {
        ...
        if (buttonsCount == 2) {
            buttonAction.maxWidth = context.resources
                    .getDimensionPixelSize(R.dimen.sendsay_sdk_in_app_message_max_buttons_width)
        }
        if (buttonsCount == 1) {
            buttonAction.maxWidth = context.resources
                    .getDimensionPixelSize(R.dimen.sendsay_sdk_in_app_message_max_button_width)
        }
