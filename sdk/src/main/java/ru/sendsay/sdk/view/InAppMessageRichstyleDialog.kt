...
import ru.sendsay.sdk.databinding.InAppMessageRichstyleDialogBinding
import ru.sendsay.sdk.models.ButtonUiPayload
import ru.sendsay.sdk.models.InAppMessageButtonType
import ru.sendsay.sdk.models.InAppMessagePayloadButton
import ru.sendsay.sdk.models.InAppMessageUiPayload
import ru.sendsay.sdk.style.ImagePosition
import ru.sendsay.sdk.style.ImageSizing
import ru.sendsay.sdk.util.Logger
import ru.sendsay.sdk.util.ensureOnMainThread
import ru.sendsay.sdk.view.component.InAppButtonView
import ru.sendsay.sdk.view.component.InAppImageView
    ...
    private fun setupContainer() {
        ...
        if (fullScreen) {
            ...
            viewBinding.inAppMessageDialogWidthLimiter.setMaxWidth(
                context.resources.getDimension(R.dimen.sendsay_sdk_in_app_message_dialog_max_width).toInt()
            )
