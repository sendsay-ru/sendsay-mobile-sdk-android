...
import ru.sendsay.sdk.services.inappcontentblock.ContentBlockCarouselViewController.Companion.EMPTY_PLACEHOLDER_ID
...
import ru.sendsay.sdk.services.inappcontentblock.ContentBlockCarouselViewHolder
import ru.sendsay.sdk.util.Logger
import ru.sendsay.sdk.util.UrlOpener
...
public class ContentBlockCarouselView : RelativeLayout, OnIntegrationStoppedCallback {
    ...
    override fun onAttachedToWindow() {
        ...
        Sendsay.deintegration.registerForIntegrationStopped(viewController)
    ...
    override fun onDetachedFromWindow() {
        ...
        Sendsay.deintegration.unregisterForIntegrationStopped(viewController)
