...
import ru.sendsay.sdk.util.fromJson
...
internal class NotificationPayload(val rawData: HashMap<String, String>) {
    ...
    data class ActionPayload(
        val action: SendsayNotificationActionType? = null,
        val url: String? = null,
    ...
    companion object {
        ...
        private fun parseActions(buttonsJson: String?): ArrayList<ActionPayload>? {
            ...
            for (i in 0 until buttonsJsonArray.length()) {
                ...
                val actionEnum = SendsayNotificationActionType.find(item["action"])
        ...
        private fun parseMainAction(actionString: String?, actionUrl: String?): ActionPayload {
            return ActionPayload(SendsayNotificationActionType.find(actionString), actionUrl)
        }
    }
}
