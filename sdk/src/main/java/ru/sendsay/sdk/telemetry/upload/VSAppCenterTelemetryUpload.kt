...
import ru.sendsay.sdk.telemetry.TelemetryUtility
...
import ru.sendsay.sdk.util.isCalledFromExampleApp
import ru.sendsay.sdk.util.isCapacitorSDK
import ru.sendsay.sdk.util.isFlutterSDK
import ru.sendsay.sdk.util.isMauiSDK
import ru.sendsay.sdk.util.isReactNativeSDK
import ru.sendsay.sdk.util.isXamarinSDK
...
internal class VSAppCenterTelemetryUpload(
    ...
    private val isRunningTest: Boolean =
        try {
            Class.forName("ru.sendsay.SendsayTestClass")
            true
