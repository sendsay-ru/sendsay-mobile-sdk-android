...
import com.sendsay.sdk.telemetry.TelemetryUtility
...
import com.sendsay.sdk.util.isCalledFromExampleApp
import com.sendsay.sdk.util.isCapacitorSDK
import com.sendsay.sdk.util.isFlutterSDK
import com.sendsay.sdk.util.isMauiSDK
import com.sendsay.sdk.util.isReactNativeSDK
import com.sendsay.sdk.util.isXamarinSDK
...
internal class VSAppCenterTelemetryUpload(
    ...
    private val isRunningTest: Boolean =
        try {
            Class.forName("com.sendsay.SendsayTestClass")
            true
