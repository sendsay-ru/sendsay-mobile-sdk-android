...
data class SendsayConfiguration(
    ...
    /** Map event types and projects to be send to Sendsay API. */
    var projectRouteMap: Map<EventType, List<SendsayProject>> = mapOf(),
    /** Authorization http header. */
    var authorization: String? = null,
    /** Base url for http requests to Sendsay API. */
    ...
    var pushChannelName: String = "Sendsay",
    ...
    private fun validateProjectToken(projectToken: String) {
        ...
        val projectTokenAllowedCharacters = ('a'..'z') + ('A'..'Z') + ('0'..'9') + '-' + '_'
