...
import com.sendsay.sdk.models.SendsayNotificationActionType.APP
import com.sendsay.sdk.models.SendsayNotificationActionType.BROWSER
import com.sendsay.sdk.models.SendsayNotificationActionType.DEEPLINK
...
import com.sendsay.sdk.models.NotificationPayload.ActionPayload
...
internal class AppInboxParser {
    companion object {
        ...
        fun parseFromHtmlMessage(source: Map<String, Any?>?): MessageItemContent {
            ...
            if (htmlOrigin != null) {
                val imageCache = Sendsay.getComponent()?.drawableCache
        ...
        private fun toJson(value: Any): String {
            ...
            return SendsayGson.instance.toJson(value)
        }
    }
}
