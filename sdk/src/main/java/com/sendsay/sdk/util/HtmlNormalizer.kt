...
import com.sendsay.sdk.repository.SimpleFileCache.Companion.DOWNLOAD_TIMEOUT_SECONDS
import java.io.File
...
class HtmlNormalizer {
    ...
    companion object {
        private const val CLOSE_URL_PREFIX = "https://sendsay.com/close_action_"
    ...
    private fun makeImageTagsToBeOffline() {
        ...
        for (image in images) {
            ...
            try {
                ...
                Logger.w(
                    this,
                    "[HTML] Image url $imageSource has not been preloaded: ${e.localizedMessage}"
                )
                throw e
            }
        }
