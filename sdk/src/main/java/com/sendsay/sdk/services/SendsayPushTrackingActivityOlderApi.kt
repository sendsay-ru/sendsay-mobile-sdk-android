...
import com.sendsay.sdk.SendsayExtras.Companion.ACTION_DEEPLINK_CLICKED
import com.sendsay.sdk.SendsayExtras.Companion.ACTION_URL_CLICKED
import com.sendsay.sdk.SendsayExtras.Companion.EXTRA_ACTION_INFO
import com.sendsay.sdk.models.NotificationAction
import com.sendsay.sdk.util.Logger

internal class SendsayPushTrackingActivityOlderApi : SendsayPushTrackingActivity() {
    ...
    override fun processPushClick(context: Context, intent: Intent) {
        ...
        } else if (intent.action == SendsayExtras.ACTION_CLICKED) {
