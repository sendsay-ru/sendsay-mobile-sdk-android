...
import com.sendsay.sdk.SendsayExtras.Companion.EXTRA_CUSTOM_DATA
import com.sendsay.sdk.SendsayExtras.Companion.EXTRA_DATA
import com.sendsay.sdk.SendsayExtras.Companion.EXTRA_DELIVERED_TIMESTAMP
import com.sendsay.sdk.SendsayExtras.Companion.EXTRA_NOTIFICATION_ID
import com.sendsay.sdk.models.NotificationData
import com.sendsay.sdk.util.Logger
import com.sendsay.sdk.util.logOnException

internal open class SendsayPushTrackingActivity : Activity() {
    ...
    open fun processPushClick(context: Context, intent: Intent) {
        ...
        Sendsay.processPushNotificationClickInternally(intent)
