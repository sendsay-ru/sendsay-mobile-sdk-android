...
import com.sendsay.sdk.models.SendsayConfiguration.Companion.BEARER_AUTH_PREFIX
    ...
    fun reset(newConfiguration: SendsayConfiguration) {
        ...
        if (configuration.advancedAuthEnabled) {
            ...
            if (customAuthProvider == null) {
                ...
                Please check your configuration against https://github.com/sendsay-ru/sendsay-mobile-sdk-android/blob/main/Documentation/AUTHORIZATION.md
                """.trimIndent()
                )
            }
        }
