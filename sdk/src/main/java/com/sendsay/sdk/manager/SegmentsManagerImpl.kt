...
internal class SegmentsManagerImpl(
    ...
    companion object {
        internal var CHECK_DEBOUNCE_MILLIS: Long = if (Sendsay.isUnitTest()) 1000L else 5000L
    }
    ...
    override fun onSdkInit() {
        ...
        val firstLoadCallbacks = Sendsay.segmentationDataCallbacks.filter { it.includeFirstLoad }
    ...
    private fun handleFetchedSegmentationsData(
        ...
        for (categoryDiff in extendedSyncResult.diffs) {
            ...
            Sendsay.getSegmentationDataCallbacks(categoryName).forEach {
    ...
    private fun areCallbacksInactive(): Boolean = Sendsay.segmentationDataCallbacks.isEmpty()
