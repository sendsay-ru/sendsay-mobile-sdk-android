...
internal class HtmlNormalizedCacheImpl(
    ...
    companion object {
        const val DIRECTORY = "sendsaysdk_html_storage"
    }
    ...
    override fun get(key: String, htmlOrigin: String): NormalizedResult? {
        ...
        try {
            ...
            val cachedHtmlWithVersion: VersionedNormalizedResult? = SendsayGson.instance.fromJson(
    ...
    override fun set(key: String, htmlOrigin: String, normalizedResult: NormalizedResult) {
        ...
        try {
            ...
            val cachedResult = SendsayGson.instance.toJson(versionedResult)
    ...
    private fun getCurrentCacheVersion() = BuildConfig.SENDSAY_VERSION_NAME
