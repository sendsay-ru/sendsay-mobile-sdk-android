...
internal class PushTokenRepositoryImpl(private val preferences: SendsayPreferences) : PushTokenRepository {

    // keeping the names for backward compatibility, but repo can contain HMS token as well as Firebase token
    private val key = "SendsayFirebaseToken"
    private val keyDate = "SendsayLastFirebaseTokenDate"
    private val keyType = "SendsayLastTokenType"
    private val keyPermFlag = "SendsayLastTokenPermissionGranted"
