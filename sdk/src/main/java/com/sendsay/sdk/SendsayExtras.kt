...
class SendsayExtras {
    companion object {
        const val ACTION_CLICKED = "com.sendsay.sdk.action.PUSH_CLICKED"
        const val ACTION_DEEPLINK_CLICKED = "com.sendsay.sdk.action.PUSH_DEEPLINK_CLICKED"
        const val ACTION_URL_CLICKED = "com.sendsay.sdk.action.PUSH_URL_CLICKED"
